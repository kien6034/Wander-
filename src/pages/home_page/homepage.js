...
class HomePage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      avatar:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtTQoyY3-n-ZnGbTbbD4xXYY7TeesIDWshXA&usqp=CAU",
      data: fakeData,
      returnData: [],
    };
  }
      ...
      <Container>
        <div className='main'>
          <div className='banner'>
            ...
            <div className='content'>
              <div className='provider_name'>
                ...
                >
                  {this.state.returnData[0] ? this.state.returnData[0].donator.name : "Wander"}
                </CustomTypography>
          ...
          <div className='chat-with-us'>
            <Link
              to={`/chatbox/${this.state.params.pid}`}
              style={{ textDecoration: "none", color: "inherit" }}
            >
              <div className='image'>
                <img
                  src='https://image.flaticon.com/icons/png/512/980/980191.png'
                  alt='chat'
                />
              </div>
            </Link>
            ...
            <div className='about'>
              ...
              <div className='description'>
                ...
                >
                  ...
                  magnam saepe et odio expedita voluptatem officia delectus
                  laboriosam laudantium veritatis vero aliquid neque non sint
                  repudiandae nesciunt culpa omnis, sed iure magni dolor
                  architecto eum molestiae. Laborum architecto eos temporibus
                  veniam iure placeat dolores a, dolore ut adipisci perferendis
                  quibusdam.
                </CustomTypography>
              </div>
            </div>
